...
namespace NewLife.Windows
{
    ...
    public partial class SerialPortList : UserControl
    {
        ...
        public void LoadInfo()
        {
            ...
            // 添加编码子菜单
            var encs = new Encoding[] { Encoding.UTF8, Encoding.ASCII, Encoding.UTF8, Encoding.Unicode, Encoding.BigEndianUnicode, Encoding.UTF32,Encoding.GetEncoding("GB2312") };
